			...
			for (Update update : updates) {
				...
				switch (update.message().text()){
					...
					case "/sobre":
						...
						resposta = "Este bot consome uma api de previs�o de tempo: HG Weather\n\n"
								+ "https://hgbrasil.com";
						break;
				default:
					resposta = "Ol� " + update.message().from().firstName() + ",  Sou o bot Tempo \n\nDigite /help para ver informa��es sobre os comando";
					break;
				}
